        ...
        try (Connection conn = Conexion.obtenerConexion()) {
            if (conn != null) {
                ...
                String sqlConsolas
                        ...
                        + "('MiSTer FPGA', 'MiSTer', 2018, 'Open Source', 'Varias', 'Global', 'FPGA', 'Altera Cyclone V', '1 GB DDR3', 'Tarjeta SD', '2018-01-01', 'tv-mister.png', 15, 800.0, 0, 'Recrea hardware retro con precisión');";
                ...
                String sqlJuegosConsolas
                        = "INSERT INTO juegos_consolas (id_juego, id_consola) VALUES (1, 1), (2, 2);";

                String sqlVotos
                        = "INSERT INTO votos (id_juego, voto, criterio, fecha_voto) VALUES "
                        + "(1, 10, 'Historia', '2025-05-01'), "
                        + "(2, 9, 'Diversión', '2025-05-02');";
                ...
                String sqlMetas
                        = "INSERT INTO metas_twitch (descripcion, meta, actual, mes, anio, fecha_inicio, fecha_fin, fecha_registro) VALUES "
                ...
                String sqlSeguidores
                        = "INSERT INTO seguidores (cantidad) VALUES (350);";

                String sqlMetasEspecificas
                        = "INSERT INTO metas_especificas (descripcion, cumplida, juegos_objetivo, juegos_completados, fabricante, fecha_inicio, fecha_fin) VALUES "
                        + "('Completar todos los juegos de consolas SEGA', 1, 5, 5, 'SEGA', '2025-04-01', '2025-05-09');";

                String sqlMejorasCanal
                        = "INSERT INTO mejoras_canal (descripcion, fecha) VALUES "
                        + "('Mejora del audio con nuevo micrófono y filtros', '2025-04-20'), "
                        + "('Nuevo overlay animado para los directos', '2025-05-05');";
